...
subplot(2,4,7), mesh(xq1,yq1,mlsVQ1), hold on, mesh(xq2,yq2,mlsVQ2); title('meshes'); hold off;
subplot(2,4,[4,8]), hdev= imshow(imresize(dev,3), [min_dev, max_dev]);
	colormap('jet'); title('ICP + interpolated MLS deviance');